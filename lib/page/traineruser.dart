...
class Traineruser extends StatefulWidget {
  final String? username;
  const Traineruser({super.key, this.username});

  @override
  _TraineruserState createState() => _TraineruserState();
}

class _TraineruserState extends State<Traineruser> {
  ...
  Future<void> deleteUser(String id) async {
    final response = await http.delete(
      Uri.parse('$apiUrl/deleteuser/$id'),
      headers: {
        'Content-Type': 'application/json',
        'Cache-Control': 'no-cache',
      },
