...
class Boxeruser extends StatefulWidget {
  final String? username;
  const Boxeruser({super.key, this.username});

  @override
  _BoxeruserState createState() => _BoxeruserState();
}

class _BoxeruserState extends State<Boxeruser> {
