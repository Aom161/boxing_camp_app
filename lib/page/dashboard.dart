...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget buildTrainingChart(String title, List<TrainingData> data, {String yAxisTitle = 'Duration', double interval = 5}) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            buildTrainingChart('การวิ่ง (นาที)', runningData, yAxisTitle: 'ระยะทาง (กิโลเมตร)', interval: 5),
            buildTrainingChart(
                'การกระโดดเชือก (นาที)', ropeJumpingData, yAxisTitle: 'จำนวนครั้ง', interval: 50),
            buildTrainingChart('การชกกระสอบทราย (นาที)', punchingData, yAxisTitle: 'จำนวนครั้ง', interval: 50),
            buildTrainingChart(
                'การยกน้ำหนัก (นาที)', weightTrainingData, yAxisTitle: 'จำนวนครั้ง', interval: 10),
          ],
        ),
      ),
    );
